...
export default class Scene1 extends Phaser.Scene
{
    ...
    create ()  {
        ...
        //  /  \  / \ 
        // 2   4 6   8 
        //default case here this is a complete tree.
		this.valList = [5,3,2,4,7,6,8];
		
		//This is the test case to make a degenerate tree.
		//this.valList = [6,5,4,3,2,1];
	...
	{
        if(this.isQuizRunning) { this.handleQuizAnswer(clickedCave); }
    }
...
//            this.MainTree.getNodeFromContent(this.valList[i]).setyCoord(nodePositionArray[i][1]);
    ...
    var caveGroup = this.add.group();
        ...
        for (let i = 0; i<this.valList.length; i++)
        {
			...
			{
				connectionLineList.push(new Phaser.Geom.Line(posNode.getxCoord(),
															posNode.getyCoord(),
